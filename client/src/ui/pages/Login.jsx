            ...
            <div className="contenedor">
                <div className="contentImg">
                    <picture>
                        ...
                        <button type="button" onClick={()=>somos()} className="btn btn-light mt-3">Conócenos</button>
                    </picture>
                </div>
                        ...
                        <h2 className="mb-2 fw-bold">¡Bienvenido!</h2>
                        {
                            !regist ?
                                ...
                                <form className="text-start mt-4">
                                    ...
                                    <button style={{"backgroundColor": "#303030", "width": "100%"}} className="btn mt-3 text-white">Rigistrar con google <i style={{"float":"right"}} className="bi bi-google"></i></button>
